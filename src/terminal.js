...
function Terminal(canv) {
    ...
    this.app_loop = function() {
        ...
        paused = false;
        curr_timeout = setTimeout(() => {terminal.app_loop();}, app_interval);
    };
